...
@endsection
    ...
    <form method="GET" action="{{ route('admin.search_consumption') }}">
        <input class="form-control me-2" style="margin: 8px auto;" type="search" id="c"
               name="c" placeholder="Поиск" aria-label="Search">
...
@if(count($finances))
    ...
    {{ $finances->appends(['c' => request()->c])->links() }}
@else
